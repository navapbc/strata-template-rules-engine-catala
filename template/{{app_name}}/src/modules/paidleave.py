"""Paid leave evaluation endpoints backed by the Catala paidleave module."""
...
router = APIRouter(prefix="/demo", tags=["paidleave"])
...
@router.post("/leave-balance", response_model=LeaveBalanceResult)
