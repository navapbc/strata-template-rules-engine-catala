...
# https://github.com/navapbc/strata-template-rules-engine-catala/issues/49#issue-1505008251
# TODO: Use classes / objects as inputs to service methods
# https://github.com/navapbc/strata-template-rules-engine-catala/issues/52
def get_user(db_session: Session, user_id: str) -> User:
    ...
    if result is None:
        ...
        # https://github.com/navapbc/strata-template-rules-engine-catala/pull/51#discussion_r1053754975
